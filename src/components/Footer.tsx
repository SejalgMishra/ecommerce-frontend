...
export const Footer = () => {
  return (
    <div>
      <footer className="text-gray-400 bg-black body-font bottom-0">
        <div className="container px-5 py-24 mx-auto flex justify-between">
          <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4 justify-between">
            <div className="px-7 flex items-baseline">
              <h1 className="text-7xl font-logo">Xyla</h1>
            ...
            <div className="lg:w-1/6 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                <li>
                  <a className="text-gray-400 hover:text-white">Mens</a>
                </li>
                <li>
                  <a className="text-gray-400 hover:text-white">Women</a>
                </li>
                <li>
                  <a className="text-gray-400 hover:text-white">Kid</a>
                </li>
                <li>
                  <a className="text-gray-400 hover:text-white">Adults</a>
                </li>
              </nav>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800">
          <div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
            <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
              ...
              <button className="btn-white bg-white hover:bg-slate-200 hover:text-black">
                Subscribe
              </button>
